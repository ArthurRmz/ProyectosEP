...
public class ResquestServiceDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.soa.ResquestServiceDocument
{
    ...
    public static class ResquestServiceImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.soa.ResquestServiceDocument.ResquestService
    {
         ...
         */
        public com.soa.MontoPagar xgetMonto()
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.soa.MontoPagar target = null;
                target = (com.soa.MontoPagar)get_store().find_element_user(MONTO$14, 0);
                return target;
            }
        }
         ...
         */
        public void xsetMonto(com.soa.MontoPagar monto)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (com.soa.MontoPagar)get_store().add_element_user(MONTO$14);
                }
                target.set(monto);
            }
        }
